...
},{}],"node_modules/highcharts/modules/drilldown.js":[function(require,module,exports) {
/*
 Highcharts JS v6.1.0 (2018-04-13)
...
},{}],"js/highcharts.js":[function(require,module,exports) {
'use strict';
...
if (!_highcharts2.default.Chart.prototype.exportChart) {
    // Exporting(Highcharts);
}

exports.default = _highcharts2.default;
},{"highcharts":"node_modules/highcharts/highcharts.js","highcharts/modules/drilldown":"node_modules/highcharts/modules/drilldown.js","highcharts/modules/exporting":"node_modules/highcharts/modules/exporting.js"}],"node_modules/d3-fetch/src/blob.js":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./src/dsv":"node_modules/d3-dsv/src/dsv.js","./src/csv":"node_modules/d3-dsv/src/csv.js","./src/tsv":"node_modules/d3-dsv/src/tsv.js"}],"node_modules/d3-fetch/src/text.js":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./src/blob":"node_modules/d3-fetch/src/blob.js","./src/buffer":"node_modules/d3-fetch/src/buffer.js","./src/dsv":"node_modules/d3-fetch/src/dsv.js","./src/image":"node_modules/d3-fetch/src/image.js","./src/json":"node_modules/d3-fetch/src/json.js","./src/text":"node_modules/d3-fetch/src/text.js","./src/xml":"node_modules/d3-fetch/src/xml.js"}],"js/data.csv":[function(require,module,exports) {
module.exports = "/data.bb7cfd2a.csv";
...
function populateSelect() {
  ...
  var select = document.querySelector(".datasets");
...
function createDrilldownObjects(_ref) {
  ...
  if (parentIndex === -1) {
    ...
    var childIndex = rootObj[parentIndex].data.findIndex(function (d) {
      return d.id === childSlug;
    });
...
(0, _d3Fetch.csv)(_data2.default).then(function (rows) {
  rows.forEach(function (code, i) {
    ...
    valueTypes.forEach(function (type, index) {
      var level1Slug = slugify([year, level1]);
      ...
      // Drilldowns
      var level2Slug = slugify([level1, level2]);
      var level3Slug = slugify([year, level2Slug]);
      var level3ID = slugify([level2Slug, level3]);
      var level4Slug = slugify([level3Slug, level4]);
      var level4ID = slugify([level3ID, level4]);
  ...
  chart = _highcharts2.default.chart("hcContainer", {
        ...
        drilldown: function drilldown(e) {
          ...
          if (!e.seriesOptions) {
            ...
            for (var i = 0; i < _series.length; i++) {
              ...
              _series[i].color = colors[colorIndex];
              _chart.addSingleSeriesAsDrilldown(e.point, _series[i]);
            }
            _chart.applyDrilldown();
          }
        }
      }
    },
    ...
    tooltip: {
      ...
      pointFormatter: function pointFormatter() {
        var point = Math.abs(this.y) > 999 && Math.abs(this.y) < 999999 ? numberWithCommas(Math.round(this.y / 1000 * 10) / 10) : Math.abs(this.y) > 999999 && Math.abs(this.y) < 999999999 ? numberWithCommas(Math.round(this.y / 1000000 * 10) / 10) : Math.abs(this.y) > 999999999 ? numberWithCommas(Math.round(this.y / 1000000000 * 10) / 10) : this.y;
        var suffix = Math.abs(this.y) > 999 && Math.abs(this.y) < 999999 ? "K" : Math.abs(this.y) > 999999 && Math.abs(this.y) < 999999999 ? "M" : Math.abs(this.y) > 999999999 ? "B" : "";
    ...
    legend: {
      ...
      title: {
        text: '<br/><span style="font-size: 12px; color: #808080; font-weight: normal">(Click the fields below to hide. To dive deeper into a specific type of funding, click a point on the chart.)</span>'
      }
    },
    xAxis: {
      title: "Fiscal Year",
    ...
    yAxis: {
      ...
      labels: {
        formatter: function formatter() {
          return this.axis.max > 999 && this.axis.max < 999999 ? "$" + numberWithCommas(this.value / 1000) + "K" : this.axis.max > 999999 && this.axis.max < 999999999 ? "$" + numberWithCommas(this.value / 1000000) + "M" : this.axis.max > 999999999 ? "$" + numberWithCommas(this.value / 1000000000) + "B" : "$" + this.value;
        }
      }
    },
    series: series
...
//# sourceMappingURL=/procurement-funding.1fa1576f.map