  ...
  chart = _highcharts2.default.chart("hcContainer", {
    ...
    chart: {
      ...
      events: {
        drilldown: function drilldown(e) {
          if (!e.seriesOptions) {
            var title = e.point.title;
            e.setTitle({ text: title });
            var _chart = this;
    ...
    tooltip: {
      ...
      pointFormatter: function pointFormatter() {
        var point = this.y > 999 && this.y < 999999 ? (this.y / 1000).toFixed(1) : this.y > 999999 && this.y < 999999999 ? (this.y / 1000000).toFixed(1) : this.y;
        var suffix = this.y > 999 && this.y < 999999 ? "K" : this.y > 999999 && this.y < 999999999 ? "M" : "";

        return "<span style=\"font-size:18px;color:" + this.series.color + "\">\u25CF</span> " + this.series.name + ": $" + point + suffix;
      }
    },
    legend: {
      title: {
