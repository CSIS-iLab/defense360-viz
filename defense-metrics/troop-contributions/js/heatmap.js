  ...
  parsed: function (columns) {
    columns.forEach(function (column, index) {
      ...
      for (let i = 0; i <= num_countries - 1; i++) {
        ...
        if (
          operation === "NATO Enhanced Forward Presence (2017-2018)" &&
          column[i] == 0
        ) {
          value = -1;
        }
    ...
    tooltip: {
      formatter: function () {
        return (
          ...
          this.key +
          "</span><br/>Troop Contribution: " +
          this.point.realValue +
          "%<br />Average Annual Troop Contribution: " +
          this.point.troops.toLocaleString()
        );
      },
    },
  });
...
function roundTo(o, t) {
  var r = !1;
  void 0 === t && (t = 0), o < 0 && ((r = !0), (o *= -1));
  var a = Math.pow(10, t);
  return (
    (o = parseFloat((o * a).toFixed(11))),
    (o = (Math.round(o) / a).toFixed(2)),
    r && (o = (-1 * o).toFixed(2)),
    o
  );
}
